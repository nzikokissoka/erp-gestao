...
@Repository
public interface AreaEspecificaRepository extends JpaRepository<AreaEspecifica, Integer>{

	//--- funcões func100: contagens -------------------------
	@Query(value="SELECT count(*) "
			   + "FROM tb_areas_especificas", nativeQuery=true)
	...
	@Query(value="SELECT * "
			   + "FROM tb_areas_especificas "
			   + "ORDER BY nome", nativeQuery=true)
	public List<AreaEspecifica> func301FindAll_OrdenarPorNome();
